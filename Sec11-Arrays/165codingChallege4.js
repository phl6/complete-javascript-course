...
HINT 2: Being within a range 10% above and below the recommended portion means: current > (recommended * 0.90) && current < (recommended * 1.10). Basically, the current portion 
...
console.log(`Sarah's Dog eating too ${sarahDog.curFood > sarahDog.recFood ? 'much' : 'little'}`); //Sarah's Dog eating too much
...
//4 Log a string to the console for each array created in 3., like this: "Matilda and Alice and Bob's dogs eat too much!" and "Sarah and John and Michael's dogs eat too little!"
console.log(`${ownersEatTooMuch.join(' and ')}'s eat too much! and ${ownersEatTooLittle.join(' and ')}'s dogs eat too little!`);

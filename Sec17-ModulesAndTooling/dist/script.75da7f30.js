...
//Exporting Module
console.log('Exporting Modules'); //these variables is scoped in this module only
...
(0, ShoppingCart.addToCart)('bread', 5);
...
(0, ShoppingCart.default)('apple', 8);
(0, ShoppingCart.default)('orange', 10);
ShoppingCart.cart.map(function (item) {
  return console.log(item.product, item.quantity);
}); // bread 5
// noodles 5
// pizza 2
// apple 8
...
var shoppingCart2 = function () {
  ...
  return {
    ...
    totalQuantity: totalQuantity // shoppingCost
...
var stateDefaultShallowClone = Object.assign({}, state);
...
},{"./shoppingCart.js":"shoppingCart.js","lodash-es/cloneDeep.js":"node_modules/lodash-es/cloneDeep.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "60831" + '/');

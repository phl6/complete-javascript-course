...
//========================================================================================================
//Section11 - 146 Coding Challenge 1
//========================================================================================================
...
const checkDogs = function(dogsJulia, dogsKate){
    const realDogsJulia = dogsJulia.slice(); //create a shallow copy or dogsJulia
    realDogsJulia.splice(0,1);
    realDogsJulia.splice(-2);

    const dogsArr = realDogsJulia.concat(dogsKate);

    dogsArr.forEach(function(dog, i){
        console.log(
            dog >= 3 ? `Dog number ${i+1} is an adult, and is ${dog} years old` : `Dog number ${i+1} is still a puppy 🐶`
        );
     });
};
...
// const a = checkDogs([9, 16, 6, 8, 3], [10, 5, 6, 1, 4]);

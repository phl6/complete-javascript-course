'use strict'
//========================================================================================================
//Section9 - 109 - Coding Challenge #1
//========================================================================================================
///////////////////////////////////////
// Coding Challenge #1
...
6.  Write a function ('printGoals') that receives an arbitrary number of player names (NOT an array) 
    and prints each of them to the console, along with the number of goals that were scored 
...
// players1.push('Thiago', 'Coutinho', 'Perisic'); //also works
console.log(players1Final);

// 5. Based on the game.odds object, create one variable for 
//    each odd (called 'team1', 'draw' and 'team2')
const {odds:{team1, x: draw, team2}} = game; //destructure game.odds into 3 separate variables
console.log(team1); //
console.log(draw);
console.log(team2);
...
//     and prints each of them to the console, along with the number of goals that were scored 
//     in total (number of player names passed in)
const printGoals = function(...players){ //the rest operator will aggregate all elements into an array
